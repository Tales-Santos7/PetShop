...
<img src="/landing-page-front.gif" alt="gif ou imagem do projeto">

#### Painel

<img src="/landing-page-painel.gif" alt="gif ou imagem do painel">

### Links

* URL do site ativo: [🛜Acesse o projeto aqui💻](https://petshop-demo.vercel.app/)

## Sobre esse Projeto

• <strong>Conteúdo personalizável</strong>: Edite textos, imagens, serviços, depoimentos e informações de contato de forma simples.<br>
• <strong>Painel de controle</strong>: Gerencie todo o conteúdo do site em um único lugar.<br>
• <strong>Integração com Instagram</strong>: Exiba publicações diretamente na página.<br>
• <strong>Controle de seções</strong>: Ative ou desative áreas como depoimentos conforme a necessidade.<br>
• <strong>Responsivo</strong>: Adaptado para computadores, tablets e smartphones.<br>
• <strong>Design moderno</strong>: Estrutura limpa, organizada e fácil de personalizar para diferentes tipos de negócio.
